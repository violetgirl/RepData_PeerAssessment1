...
```
Mean equals `r mean_1` and median equals `r median_1`
...
```
Answer: the interval `r interval_1`
...
```
For data set without missing values: Mean equals `r mean_1` and median equals `r median_1`

For the data set with filled in missing values: Mean equals `r mean_2` and median equals `r median_2`
